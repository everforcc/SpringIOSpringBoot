...
~~~
JTree表示一个树组件，负责把内存中构造的整颗结构树显示出来。因为对于树结构，只需要得到一个根节点，就相当于获取到了整棵树的应用，因此只需要把一颗树的根节点传递给 JTree 便可显示整棵树。
~~~
...
- [javax.swing.JTree](https://docs.oracle.com/javase/8/docs/api/javax/swing/JTree.html)
