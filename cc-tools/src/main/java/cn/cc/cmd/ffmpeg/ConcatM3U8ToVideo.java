...
import cn.cc.cmd.ffmpeg.constant.ConstantFFmpeg;
...
public class ConcatM3U8ToVideo {
     ...
     *
     * @param path    m3u8 文件所在路径         E:\filesystem\project\SpringIOSpringBoot\sp92-tools\cn.cc.cmd\ffmpeg\m3u8\视频.m3u8
     * @param oldPath 文件内的旧路径 示例        "file:///storage/emulated/0/Quark/Download"
     *                newPath 文件内的新路径 示例        "E:\\\\filesystem/project/SpringIOSpringBoot/sp92-tools/cn.cc.cmd/ffmpeg/m3u8"
     */
