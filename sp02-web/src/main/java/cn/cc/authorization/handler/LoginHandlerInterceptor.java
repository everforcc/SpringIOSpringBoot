package cn.cc.authorization.handler;

import cn.cc.authorization.annotation.Authorization;
import cn.cc.authorization.constant.AuthorizationConstants;
import cn.cc.authorization.dto.CustomUser;
import cn.cc.authorization.utils.IToken;
import cn.cc.authorization.utils.impl.TokenJSON;
...
public class LoginHandlerInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        String token = request.getHeader(AuthorizationConstants.token);
        ...
        request.setAttribute(AuthorizationConstants.customUser, customUser);
        return true;
    }
}
