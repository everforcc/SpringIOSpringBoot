...
package cn.cc.authorization.utils;
...
//        outputStream.write((R.fail("被拦截返回异常信息:" + msg).toString()).getBytes(StandardCharsets.UTF_8));
//        outputStream.flush();
//        outputStream.close();
        throw new RuntimeException("被拦截返回异常信息:" + msg);
    }
